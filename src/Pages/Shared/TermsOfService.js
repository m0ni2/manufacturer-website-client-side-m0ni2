...
const TermsOfService = () => {
    return (
        <div className='container mt-5 mx-auto mx-12'>
            ...
            <p>
                1.2       By impliedly or expressly accepting these Terms, you also accept and agree to be bound by MrTools Policies (including but not limited to Privacy Policy available at https:// MrTools/t/PrivacyInfo) as amended from time to time.
            </p>
            <p>
                1.3       In these Terms references to "you", and "User" shall mean the end-user/customer accessing the Website, its contents, and using the Services offered through the Website. References to the “Website”,  MrTools, “ MrTools”, "we", "us", and "our" shall mean the Website and/or MrTools Limited.
            </p>
            <p>
            ...
            <p>
                1.5       The Website is operated by MrTools Limited., a company incorporated under the laws of Bangladesh having its registered office at 165 DIT Extension Road, Fakirapool, Dhaka, Bangladesh. All references to the Website in these Terms shall deem to refer to the aforesaid entity in inclusion of the online portal.
            </p>
            <p>
                1.6       This Website may also contain links to other websites, which are not operated by  MrTools, and MrTools has no control over the linked sites and accepts no responsibility for them or for any loss or damage that may arise from your use of them. Your use of the linked sites will be subject to the terms of use and service contained within each such site.
            </p>
            <p>
            ...
            <p>
                1.8       These Terms will continue to apply until terminated by either You or MrTools in accordance with the terms set out below:
            </p>
            <p>
                1.9       The agreement with MrTools can be terminated by (i) not accessing the Website; or (ii) closing Your Account, if such an option has been made available to You.
